...
```go
	...
	func MyHandler(w http.ResponseWriter, r *http.Request) {
		// Get a sessions. We're ignoring the error resulted from decoding an
		// existing sessions: Get() always returns a sessions, even if empty.
		session, _ := store.Get(r, "sessions-name")
